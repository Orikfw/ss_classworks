...
"""Створити список цілих чисел, та знайти серед них
...
"""На вхід подається к-сть елементів послідовності. Якщо зустрічається
від'ємне чи нуль - програма зупиняється"""
try:
